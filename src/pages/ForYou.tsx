...
export default function ForYou() {
  ...
  const renderFeedItem = (item: any) => {
    ...
    switch (type) {
      case 'FlashDeals':
        return <FlashDeals key={id} onProductClick={handleProductClick} />;
      ...
      case 'NewArrivalsSection':
        return <NewArrivalsSection key={id} onProductClick={handleProductClick} />;
  ...
  // Show content immediately without skeleton loading
